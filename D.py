...
print("\u001b[31m Welcome to SAMP-Yassine World")
time.sleep(2)
print("Loading.......")
os.system("clear")
...
while attemps < 100:
    username = input('D5EL SMIYA DYAL DDOS: ')
    password = input('D5EL CODE DYAL DDOS: ')

    if username == '15x3' and password == '15x3':
        print('mrhba bik f Ddos Dyal yassine_15x3!!')
        break
    else:
...
print("""
\u001b[31m
	  AUTHOR TOOLS : Yassine_15x3{Num:+212608419590}
	╔═╗╔═╗╔╦╗╔═╗    ╔╦╗╔╦╗╔═╗╔═╗
	╚═╗╠═╣║║║╠═╝───  ║║ ║║║ ║╚═╗
	╚═╝╩ ╩╩ ╩╩      ═╩╝═╩╝╚═╝╚═╝ V 1 Team_15x3
""")
